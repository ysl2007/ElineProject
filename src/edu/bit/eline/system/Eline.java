...
public class Eline {
	...
	public static String classifyOneImg(BufferedImage img){
		...
		return ic.classifyOneImg("4 "+feature,"E:\\电网项目\\config\\models\\model0.0.4.0.model","E:\\电网项目\\config\\models\\scale.params");
	            ...
	            if (img != null) {
	              ...
	              //  bufimg=converter.convert2JavaImg(mat)
	                ...
	                for (Blob blob : blobList) {
	                	...
	                	//BufferedImage subimg=converter.convert2JavaImg(blob.cutByBorder(img));
	                 ...
	                 /*     try{
		                    File outputfile = new File("E:/examples/Detected/"+Integer.toString(i+1)+"-"+Integer.toString(blobnum)+".jpg");
	...
	public static void main(String[] args){
		...
		//提取特征
		//ExtractFeature ef=new ExtractFeature();
		//ef.extractFoldfeature("E:\\电网项目\\config\\classes", "E:\\电网项目\\config\\features\\0.0.4.0.features.feature");
		
		//归一化并保存参数模型(True为保存)
		ImageClassification ic=new ImageClassification();
		//ic.scaledata("E:\\电网项目\\config\\features\\0.0.4.0.features.feature", "E:\\电网项目\\config\\features\\0.0.4.0.features.feature.scale", true, "E:\\电网项目\\config\\models\\scale.params");
	    //生成训练数据和预测数据
		//ic.generateTrainPredict("E:\\电网项目\\config\\features\\0.0.4.0.features.feature.scale", 50, "E:\\电网项目\\config\\features\\0.0.4.0.train.feature", "E:\\电网项目\\config\\features\\0.0.4.0.predict.feature");
		
		//参数优化
		//String []classes={"0.0","4.0"};
		//String result=ic.paramoptimize("E:\\电网项目\\config\\features\\0.0.4.0.train.feature", "E:\\电网项目\\config\\models\\model0.0.4.0.model","E:\\电网项目\\config\\features\\0.0.4.0.predict.feature","E:\\电网项目\\config\\temp\\0.0.4.0.result",classes );
	  ...
	  //  Best C: 1.0 Best G: 9.765625E-4 Best Acc: 0.9756097793579102
	   // ic.train("-t 2 -c 2.0 -g 0.00390625", "E:\\电网项目\\config\\features\\0.0.4.0.features.feature.scale", "E:\\电网项目\\config\\models\\model0.0.4.0.model");
	   // ic.predict("-b 0", "E:\\电网项目\\config\\features\\0.0.4.0.predict.feature", "E:\\电网项目\\config\\models\\model0.0.4.0.model", "E:\\电网项目\\config\\temp\\0.0.4.0.result");
