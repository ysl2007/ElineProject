...
public class HttpInterface {
    ...
    private static String encodeTwice(String str)
    ...
    public static List<String> getImageList(String lineName, String start,
            String end) {
        ...
        try {
            ...
            String url = imgListUrl + lineName + "&Type=2&StartDate=" + start
                    + "&EndDate=" + end;
            is = connect(url);
        ...
        if (result.length() == 0 || result.startsWith("null")
                || result.startsWith("[]")) {
            return imageList;
        }
